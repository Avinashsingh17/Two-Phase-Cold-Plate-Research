...
- [[mudawar_group]] — Purdue PUREES Lab (Issam Mudawar); CHF database, boiling, microchannels  [3 sources]
- [[garimella_group]] — Purdue CTRC (Suresh Garimella); manifold microchannels, dielectric two-phase cooling, topology optimization  [2 sources]
...
- [[motivation_for_CFD_approach]] — Why correlations are insufficient for water microchannel design; Qu & Mudawar 2003 + Kim & Mudawar 2013 + Ozguc 2024 evidence  [3 sources]
- [[open_questions]] — Consolidated tracker of all open TODOs and unresolved questions across the wiki  [5 papers]
- [[baseline_decision]] — Drummond 2018 adopted as optimization baseline target with HFE-7100; fluid-mismatch resolution recorded  [1 source]
